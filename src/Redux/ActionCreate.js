...
export const CreateCompany = (data) => {
    return (dispatch) => {
        axios.post("http://localhost:3000/company", data).then(res => {
...
export const UpdateCompany = (data) => {
    return (dispatch) => {
        axios.put("http://localhost:3000/company/"+data.id, data).then(res => {
...
export const RemoveCompany = (code) => {
    return (dispatch) => {
        axios.delete("http://localhost:3000/company/"+code).then(res => {
